...
class Annotator:
    ...
    def draw_specific_points(
        self, keypoints, indices=[2, 5, 7], shape=(640, 640), radius=2, conf_thres=0.25
    ):
        """
    ...
    def plot_angle_and_count_and_stage(
        ...
        cv2.putText(
            self.im, angle_text, angle_text_position, 0, self.sf, txt_color, self.tf
        )
        ...
        cv2.putText(
            self.im, count_text, count_text_position, 0, self.sf, txt_color, self.tf
        )
        ...
        cv2.putText(
            self.im, stage_text, stage_text_position, 0, self.sf, txt_color, self.tf
        )
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    ...
    import seaborn  # scope for easter 'import ultralytics'
